...
(function () {
  ...
  function db() {
    ...
    DBP = new Promise(function (res, rej) {
      var rq = indexedDB.open('psa_db', 3);
      ...
      function worker() {
        return (function next() {
          ...
          return new Promise(function (res) { setTimeout(res, GAP_MS); })
            .then(function () { return search(opts.pad ? pad5(kw) : kw); })
            .then(function (r) {
  ...
  log('موتور API نسخه ۳ (IndexedDB) آماده است. فرمان‌ها: __psaRunIRC() | __psaRunSupp() | __psaRunGen() | __psaRunPrice() | __psaStatus() | __psaStop() | __psaExportIRC() | __psaExportSupp() | __psaExportGen() | __psaExportPrice()');
  migrate();
  ensureList(function () {});
})();
