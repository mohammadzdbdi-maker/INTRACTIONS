...
(function () {
  ...
  function db() {
    ...
    DBP = new Promise(function (res, rej) {
      var rq = indexedDB.open('psa_db', 1);
  ...
  window.__psaStatus = function () {
    Promise.all([countStore('irc'), countStore('gen')]).then(function (c) {
  ...
  log('موتور API نسخه ۲ (IndexedDB) آماده است. فرمان‌ها: __psaRunIRC() | __psaRunGen() | __psaStatus() | __psaStop() | __psaExportIRC() | __psaExportGen()');
  migrate();
  ensureList(function () {});
})();
