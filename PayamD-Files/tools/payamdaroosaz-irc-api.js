...
(function () {
  ...
  function db() {
    ...
    DBP = new Promise(function (res, rej) {
      var rq = indexedDB.open('psa_db', 2);
  ...
  window.__psaStatus = function () {
    Promise.all([countStore('irc'), countStore('gen'), countStore('price')]).then(function (c) {
  ...
  log('موتور API نسخه ۲ (IndexedDB) آماده است. فرمان‌ها: __psaRunIRC() | __psaRunGen() | __psaRunPrice() | __psaStatus() | __psaStop() | __psaExportIRC() | __psaExportGen() | __psaExportPrice()');
  migrate();
  ensureList(function () {});
})();
